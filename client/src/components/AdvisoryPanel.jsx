const ACTION_STYLES = {
  APPLY:   { bg: 'bg-agri-900/60', border: 'border-agri-700', text: 'text-agri-400' },
  HARVEST: { bg: 'bg-earth-50/5',  border: 'border-earth-600', text: 'text-earth-400' },
  WAIT:    { bg: 'bg-blue-900/40', border: 'border-blue-700', text: 'text-blue-400'  },
  HOLD:    { bg: 'bg-red-900/30',  border: 'border-red-800',  text: 'text-red-400'   },
  NONE:    { bg: 'bg-slate-800/40',border: 'border-slate-700',text: 'text-slate-400' },
};
    ...
    <div className={`glass-card p-5 border ${style.border} ${style.bg} fade-in`}>
      <div className="flex items-center gap-3 mb-4">
        ...
        {advisory.validatorPassed === false && (
          <span className="ml-auto px-2 py-1 bg-red-900/60 text-red-300 text-xs rounded-lg">Validator Override</span>
        )}
      </div>
      ...
      <div className="space-y-3 text-sm">
        ...
        <div className="bg-white/5 rounded-lg p-3">
          <p className="text-slate-400 text-xs mb-1">Decision Reason / निर्णय का कारण</p>
